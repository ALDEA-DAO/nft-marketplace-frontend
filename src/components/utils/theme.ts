...
export const ButtonBase =
  "flex items-center justify-center flex-shrink-0 font-normal w-auto uppercase rounded-10px outline-none transition duration-250 ease-in-out focus:outline-none";
export const ButtonVariant = {
  // primary: 'text-white bg-primary hover:bg-primary-hover',
  primary: "text-white bg-celeste-aldea hover:bg-celeste-hoveraldea",
  secondary: "text-white bg-gray-900 hover:bg-gray-700",
  elevation: "text-white bg-gray-900 hover:bg-gray-700 shadow-upside",
};
...
export const CounterBase =
  "group flex items-center justify-between flex-shrink-0 rounded-10px overflow-hidden bg-gray-500 shadow-floatingUp";
...
export const CartItemImage = 
  "flex w-105px h-105px rounded overflow-hidden bg-gray-200 flex-shrink-0 cursor-pointer";

export const CartItemContent = "flex flex-col w-full px-15px";

export const CartItemName = "text-13px text-gray-700 cursor-pointer";
...
// ----------
export const ItemCardBase = "rounded-10px border border-1 border-gray-400 cursor-pointer hover:shadow-image-item";
// "w-full md:w-300px h-400px border-gray-200 border rounded-10px cursor-pointer product-item hover:shadow-image-hoveritem"
// "w-full relative cursor-pointer product-item";

export const ItemCardBaseContent = "pb-5px h-auto rounded-10px overflow-hidden";
  // "flex items-center h-full border-gray-300 border rounded";

export const ItemCardIcon = "";
  // "relative w-15px h-15px flex-shrink-0 xl:w-18px xl:h-18px";

export const ItemCardImage = "w-280px h-280px border border-gray-300 m-10px ml-20px mr-20px mt-20px rounded-10px overflow-hidden";
...
export const ItemCardContent = "w-280px m-auto";
// "flex flex-col items-start";

export const ItemCardPrice = "font-bold text-gray-700 float-right";
  // "font-normal text-gray-700 mb-2";

export const ItemCardName = "";
  // "font-semibold text-gray-900 mb-1";

export const ItemCardInformation = "w-280px m-auto mb-20px";
  // "flex items-center";

export const ItemCardType = "bg-gray-600 p-3px text-10px text-white rounded";
  // "text-gray-500 text-11px capitalize";

export const ItemCardRoundedDot = "";
  // "flex bg-gray-500 w-3px h-3px rounded mx-3 flex-shrink-0";

export const ItemCardQuantityFalse = "float-right bg-verde-aldea p-3px text-10px text-white rounded";
export const ItemCardQuantityPending = "float-right bg-amarillo-aldea p-3px text-10px text-white rounded";
export const ItemCardQuantityTrue = "float-right bg-rojo-aldea p-3px text-10px text-white rounded";

export const ItemCardDetailsAnimatedWrapper = "w-320px rounded-10px p-20px -mt-15px absolute bg-white z-10 shadow-image-hoveritem";
...
export const ItemCardDetailsTitle = "";
  // "text-gray-500 text-11px mb-2";

export const ItemCardDetailsInfo = "";
  // "font-normal text-13px capitalize text-gray-900";

export const ItemCardCounterWrapper = "mt-20px";
...
export const InstagramItemBase =
  "block rounded-lg overflow-hidden transition-all duration-150";
...
export const HeroCarouselBase =
  ...
  "w-full flex items-center px-40px md:px-80px height-banner";
